...
def simulate_SI(
    ...
    (
        ...
        parti_age_group,
        parti_wealth_group
    ) = simulate_cohorts_SI(Y, biasvec, dZ, dZ_SI, Nt, Nc, tau, dt, Ntype, rho_i, beta_i, beta_cohort_type, beta0, nu,
...
def simulate_SI_mean_vola(
    ...
    (
        ...
        parti_group_matrix,
        cov_save_matrix,
    ) = simulate_cohorts_mean_vola(Y, biasvec, dZ, dZ_SI, Nt, tau, dt, Ntype, rho_i, beta_i, beta_cohort_type, beta0, nu,
                            Vhat, mu_Y, sigma_Y, tax, phi, T_hat, Npre, mode_trade, mode_learn,
                            cohort_type_size, cutoffs_age, Delta_s_t, eta_st_eta_ss, X, d_eta_st, invest_tracker_build,
