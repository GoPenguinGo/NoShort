...
if __name__ == '__main__':
    ...
    for i, T_hat_try in enumerate(T_hat_vec):
        E_util_learn_path = np.load(folder_address + str(int(T_hat_try)) + "all_runs.npz")['E_util']
    ...
    ax.plot(T_hat_vec, equiv_mu[:, 1], color='red', linewidth=1.5, label=r'type 2, $\rho=0.005$')
