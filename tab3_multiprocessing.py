...
from src.param_mix import Nconstraint, alpha_i_mix, cohort_type_size_mix
...
def simulate_mean_vola_path(i: int,
    ...
    dR_mean_vola_results = np.zeros((Nvar, Nscenario, 2))
    theta_mean_vola_results = np.zeros((Nvar, Nscenario, 2))
    ...
    for h in range(Nvar):
        ...
        for g in range(Nscenario):
            ...
            dR_mean_vola_results[h, g] = dR_mean_vola
            theta_mean_vola_results[h, g] = theta_mean_vola
            ...
            parti_wealth_group_mean_vola_results[h, g] = parti_wealth_group_mean_vola
