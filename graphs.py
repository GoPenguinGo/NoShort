...
ax2.plot(
    ...
    linewidth=0.4,
    linestyle="--",
    label="Market view, complete market",
)
...
ax1.set_ylim([0, 1])
ax1.fill_between(
    t, y51, color="steelblue", linewidth=0.4, label="20 < Age <= 35, youngest quartile"
)
ax1.fill_between(
    t, y52, y51, color="darkseagreen", linewidth=0.4, label="35 < Age <= 55"
)
ax1.fill_between(t, y53, y52, color="moccasin", linewidth=0.4, label="55 < Age <= 89")
ax1.fill_between(
    t, y54, y53, color="pink", linewidth=0.4, label="Age > 89, oldest quartile"
)
...
ax1.set_ylim([0, 0.02])
ax1.fill_between(
    t, y51, color="steelblue", linewidth=0.1, label="20 < Age <= 35, youngest quartile"
)
ax1.fill_between(
    t, y52, y51, color="darkseagreen", linewidth=0.1, label="35 < Age <= 55"
)
ax1.fill_between(t, y53, y52, color="moccasin", linewidth=0.1, label="55 < Age <= 89")
ax1.fill_between(
    t, y54, y53, color="pink", linewidth=0.1, label="Age > 89, oldest quartile"
)
# ax1.fill_between(t, y51, color='lavender', linewidth=0.4, label='20 < Age <= 35, youngest quartile')
# ax1.fill_between(t, y52, y51, color='lightsteelblue', linewidth=0.4, label='35 < Age <= 55')
# ax1.fill_between(t, y53, y52, color='steelblue', linewidth=0.4, label='55 < Age <= 89')
...
theta_hat = (
    theta_drop + Delta_bar_parti_drop
)  # wealth weighted average subjective risk premia
# regression:
x1 = dZ.reshape((-1, 1))
